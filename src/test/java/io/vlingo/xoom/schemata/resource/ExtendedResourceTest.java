...
public class ExtendedResourceTest extends ResourceTest {
    ...
    private final ContextData contextData10 = ContextData.just("io.vlingo.xoom.schemata" , "Namespace1 descrption");
    private final ContextData contextData11 = ContextData.just("io.vlingo.xoom.lattice" , "namespace 1b descrption");
    ...
    private final ContextData contextData2 = ContextData.just("io.vlingo.xoom.http" , "Namespace HTTP!");
